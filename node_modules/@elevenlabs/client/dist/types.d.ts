 ...
 */
export type MCPToolApprovalRequest = Extract<McpToolCallClientEvent["mcp_tool_call"], {
 ...
 */
export type MCPToolApprovalHandler = (toolCall: MCPToolApprovalRequest, context: MCPToolApprovalRequestContext) => Promise<boolean> | boolean;
/**
